...
export function Login(){
    const d = document,
        ...
        $login.classList.add("contact-form");
        ...
        function validationsForm(){
            const $login = d.querySelector(".contact-form"),
            ...
            d.addEventListener("submit", (e)=>{
                ...
                const $loader = d.querySelector(".contact-form-loader"),
                      $inputCorreo = d.querySelectorAll(".contact-form [required]")[0],
                      $inputPassword = d.querySelectorAll(".contact-form [required]")[1],
                ...
                let   correo = $inputCorreo.value,
                      ...
                      fetch("https://mi-primer-restserver.herokuapp.com/api/auth/login",
                            {method: "POST",
                            headers: {
